...
const config = {
  generator: {
    ...
    output: {
      value:
        '/home/coffee/Desktop/magick/portal/cloud/packages/db/src/lib/prisma/client-portal',
      fromEnvVar: null,
    },
    config: {
      name: 'prisma',
