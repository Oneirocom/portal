...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/jakobgrant/Workspaces/Oneirocom/Magick/portal/cloud/packages/db/src/lib/prisma/client-portal',
      fromEnvVar: null,
    },
    config: {
      name: 'prisma',
...
path.join(
  process.cwd(),
  'src/lib/prisma/client-portal/libquery_engine-darwin-arm64.dylib.node'
)
// file annotations for bundling tools to include these files
