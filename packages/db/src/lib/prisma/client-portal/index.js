...
<<<<<<< HEAD
    "packages/db/src/lib/prisma/client-portal",
    "db/src/lib/prisma/client-portal",
=======
...
path.join(process.cwd(), "packages/db/src/lib/prisma/client-portal/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/db/src/lib/prisma/client-portal/schema.prisma")
=======
